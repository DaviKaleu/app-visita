-- Top Planejados V69 Online
-- Rode no Supabase: SQL Editor > New query > Run.
-- Esta migration não apaga dados. Ela só atualiza descrições/compatibilidade da V69.

update public.tab_settings
set title = 'Projetista 3D Pro',
    description = 'Projetista técnico com 3D SVG estável, abertura de portas/gavetas, movimentação corrigida no orbital e lista de peças agrupada.',
    enabled = true,
    order_index = 38
