-- Top Planejados V67 Online
-- Rode no Supabase: SQL Editor > New query > Run.
-- Esta migration não apaga dados. Ela só atualiza descrições/compatibilidade da V67.

update public.tab_settings
set title = 'Projetista 3D Pro',
    description = 'Projetista técnico com 3D SVG estável, câmera orbital por arraste, paredes/chão sólidos, módulos em polígonos e peças iguais agrupadas.',
    enabled = true,
    order_index = 38
