-- Top Planejados V75 Online
-- Rode no Supabase: SQL Editor > New query > Run.
-- Não apaga dados. Atualiza apenas textos/compatibilidade.

update public.tab_settings
set title = 'Projetista 3D Pro',
    description = 'Projetista técnico com portas/gavetas visivelmente abertas na visualização, cuba plana estética sem torneira, puxadores e contornos melhores na exportação.',
    enabled = true,
    order_index = 38
