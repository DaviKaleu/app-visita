-- Top Planejados V76 Online
-- Rode no Supabase: SQL Editor > New query > Run.
-- Não apaga dados. Atualiza apenas textos/compatibilidade.

update public.tab_settings
set title = 'Projetista 3D Pro',
    description = 'Projetista técnico com cuba como imagem plana, parede/piso com controles claros de pintura e grade desligada por padrão.',
    enabled = true,
    order_index = 38
