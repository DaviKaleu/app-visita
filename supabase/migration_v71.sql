-- Top Planejados V71 Online
-- Rode no Supabase: SQL Editor > New query > Run.
-- Esta migration não apaga dados. Ela só atualiza descrições/compatibilidade da V71.

update public.tab_settings
set title = 'Projetista 3D Pro',
    description = 'Projetista com rolagem separada por painel, nichos abertos corrigidos, materiais frente/corpo, orbital, peças agrupadas e portas/gavetas abertas.',
    enabled = true,
    order_index = 38
