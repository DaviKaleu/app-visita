...
-- V63: ajustes de descrição das abas e preparação do Projetista 3D técnico.
update public.tab_settings
set title = 'Projetista 3D',
    description = 'Projetista técnico de móveis planejados: parede/chão sólidos, snap entre móveis, teclado, exportação de imagem, peças e orçamento.',
    enabled = true,
    order_index = 38
